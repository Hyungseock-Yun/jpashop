...
public class OrderRepository {
  ...
  public List<Order> findAllByString(OrderSearch orderSearch) {   /* 동적 쿼리 이렇게 쓰지 않음. */
   ...
   *  JPA Criteria
   */
  public List<Order> findAllByCriteria(OrderSearch orderSearch) {   /* Criteria도 사용 안함. 너무 복잡. */
